    ...
    <div className="flex flex-col lg:flex-row lg:gap-4 gap-2 items-center justify-center p-4">
      ...
      >
        ...
        <div className="mt-3 flex lg:flex-col flex-row gap-2 mb-5">
          <Link href="https://rojoniaina.vercel.app/" className="flex space-x-2 items-center bg-violet-800 border border-violet-800 text-white px-4 py-2 rounded-xl hover:bg-white hover:text-violet-800 hover:border hover:border-gray-300 ">
